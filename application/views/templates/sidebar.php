<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="<?php echo base_url() ?>index.php/transupn/">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url() ?>index.php/driver/">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url() ?>index.php/kondektur/">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url() ?>index.php/sallary/">
